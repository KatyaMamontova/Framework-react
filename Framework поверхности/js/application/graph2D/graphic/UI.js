...
class UI {
    ...
    createMenu() {
        ...
        const draw = timePassed => div.style.top = 100 + timePassed / 10 + 'px';
    };
    ...
    addFunction() {
        ...
        inputIntegral.style.width = '20px';
