class UniversalCalculator extends RealCalculator{
    ...
    one(type, elem) {
        ...
        switch(type){
            ...
            case 'Matrix': return (new MatrixCalculator).one(elem.values.length, elem.values[0]);
    ...
    zero(type, elem) {
        ...
        switch(type){
            ...
            case 'Matrix': return (new MatrixCalculator).zero(elem.values.length, elem.values[0]);
